...
```
/nxos crie um squad para [o que você precisa]
/nxos execute o squad meu-squad
```

## Criar um Squad

Digite `/nxos` e escolha "Criar squad" no menu, ou seja direto:
...
Digite `/nxos` e escolha "Executar squad" no menu, ou seja direto:

```
/nxos execute o squad <nome-do-squad>
```
...
```
/nxos create a squad for [what you need]
/nxos run my-squad
```

## Create a Squad

Type `/nxos` and choose "Create squad" from the menu, or be direct:
...
Type `/nxos` and choose "Run squad" from the menu, or be direct:

```
/nxos run the <squad-name> squad
```
