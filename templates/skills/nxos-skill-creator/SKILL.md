---
name: nxos-skill-creator
description: Create new nxos skills, modify and improve existing skills, and measure skill performance. Use when users want to create a skill for their squads, update or optimize an existing skill, run evals to test a skill, or benchmark skill performance. Supports all nxos skill types: MCP integrations, custom scripts, hybrid, and behavioral prompts.
---

# nxos Skill Creator

A skill for creating new nxos skills and iteratively improving them.

At a high level, the process of creating a skill goes like this:

- Decide what you want the skill to do and roughly how it should do it
- Write a draft of the skill
- Create a few test prompts and run a nxos agent with the skill injected into its context
...
The with-skill run simulates how a nxos agent operates with this skill injected into its context. The skill's SKILL.md body gets appended to the agent's instructions, just like the pipeline runner does during actual squad execution.
...
- Instructions: Read the skill's SKILL.md and follow its instructions as if you were a nxos agent with this skill active.
```
...
- `references/skill-format.md` — nxos SKILL.md frontmatter schema per skill type
...
- Run a nxos agent with the skill injected into its context on test prompts
